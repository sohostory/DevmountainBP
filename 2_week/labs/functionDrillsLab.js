...
const helloWorld = () => {
  console.log("Problem 1:", "Hello, World!");
};
...
const jsNinja = () => {
  console.log("Problem 2:", "I am a Javascript ninja!");
};
...
const greeting = (name) => {
  console.log("Problem 4: ", `Hello, ${name}`);
};
...
console.log("Problem 5:", compareNums(5, 4));
...
console.log("Problem 7:", "expression");
...
console.log("Problem 8:", exclaimThree("Exclaim Me"));
...
// console.log('arrow')
console.log("Problem 9:", "declaration");
// console.log('expression')
...
console.log("Problem 10:", nameGreeting);
...
console.log("Problem 11:", colorRating);
...
const printAllNames = (array) => {
  for (let i = 0; i < array.length; i++) {
    console.log("Problem 12:", array[i]);
  }
};
...
console.log("Problem 13:", oddChecker);
...
const bestMovies = (movie) => `${movie} is the best movie ever!`;

console.log("Problem 14:", bestMovies("Titanic"));
...
console.log("Problem 15:", arrayEvaluator);
...
const theEliminator = (array, name) => {
  for (let i = 0; i < array.length; i++) {
    if (array[i] === name) {
      array.splice(i, 1);
    }
...
console.log("Problem 16:", newContestants);
...
const upperCaseIt = (string) =>
  console.log("Problem 17:", string.toUpperCase());

upperCaseIt("upper case me!");
...
console.log("Problem 18:", emailCheck("abc@abc.com"));
...
function buyChocolateFrogs(coins) {
  let ableToBuy = Math.floor(coins / 3);
  return ableToBuy;
}

let totalFrogs = buyChocolateFrogs(19);

console.log("Problem 19:", totalFrogs);
...
console.log("Problem 20:", totalFrogs2);

////////////////// PROBLEM 21 ////////////////////
let sampleArray = [0, 1, 2, 3, 4, 7, 8, 6, 8, 9];
/*
...
console.log("Problem 21:", arrayIsAscending);
