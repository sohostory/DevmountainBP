...
/*
The code above is an example of 'function declaration.' 
Please re-write the function in 'function expression' and 'arrow function' syntaxes. 
*/
...
const printParameters = (param1, param2) =>
  `The first parameter is ${[param1]}. The second parameter is ${param2}.`;

// INVOKE THE FUNCTION HERE. THE PARAMETERS TAKE ANY DATATYPE.
console.log("Problem 2:", printParameters(10, 4));
...
Then, outside of the greeting function, invoke the greeting function, passing in the value firstName
and lastName of your choice, and a callback function that takes a parameter of fullName. 
...
greeting("Michael", "Jordan", (fullName) => {
  console.log("Problem 3:", `Hello, my full name is ${fullName}`);
});
...
Invoke the 'pricesPlusTax' function, passing in the 'prices' array and a callback function (passing in 'totalCost' as a param)
that will print "The new array plus tax = [totalCost]"
*/

// CODE HERE

pricePlusTax(prices, (newArray) =>
  console.log("Problem 4:", `The new array plus tax = ${newArray}`)
);
...
const multiplyingFactory = (x) => (y) => {
  if (x >= 5) {
    console.log("Problem 5:", x * y);
  } else {
    console.log(
      "Problem 5:",
      "Cannot multiply: the first number is smaller than 5."
    );
  }
};
