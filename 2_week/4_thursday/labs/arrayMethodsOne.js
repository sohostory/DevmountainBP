...
console.log("Problem 1:", evenNumbers);
...
// CODE HERE
const postTaxPrices = prices.map((price) => (price * 1.07).toFixed(2));

console.log("Problem 2:", postTaxPrices);
...
console.log("Problem 3:", totalPopulation);
...
console.log("Problem 4:", myStrongest);
...
const totals = orders.map((order) =>
  (order.price * (1 + order.tax)).toFixed(2)
);
console.log("Problem 5:", totals);
...
const bobsTotal = purchases.reduce((a, c) => a + c.price, 0);

console.log("Problem 6:", bobsTotal);
