...
numbers.forEach((number) => console.log("Problem 1:", number / 2));
...
console.log("Problem 2:", newNumbers);
...
const iCity = cities.filter((city) => city.charAt(city.length - 1) === "i");
console.log("Problem 3", iCity);
...
fruits.forEach((fruit, i) => {
  switch (fruit.color) {
    case "red":
      console.log("Problem 4:", `The fruit with index ${i} is an apple.`);
      break;
    case "orange":
      console.log("Problem 4:", `The fruit with index ${i} is an orange.`);
      break;
    default:
      console.log(
        "Problem 4:",
        `The fruit with index ${i} is neither apple or orange.`
      );
  }
});
...
// Problem 4: The fruit with index 0 is neither apple or orange.
// Problem 4: The fruit with index 1 is an orange.
// Problem 4: The fruit with index 2 is neither apple or orange.
// Problem 4: The fruit with index 3 is an apple.
...
const totalPriceRice = foods
  .filter((food) => food.tags.includes("rice"))
  .reduce((a, c) => a + c.price, 0);

// THE TOTAL

console.log("Problem 5:", totalPriceRice);
