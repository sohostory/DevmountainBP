...
/*
  ...
  one should wear a jacket and carry an umbrella. Come up with your own clothing suggestions based on those temperature parameters 
...
if (temperature >= 80 && rain) {
  console.log("Wear a t-shirt and taken an umbrella");
